<?php include('C:\xampp\htdocs\COLLEGE\Admin\navbar.php'); ?>
 ...
 <?php include('../connection.php');  ?>
      <?php
           if(isset($_GET['id'])){
            $id = $_GET['id'];
            $sql = "select id,aname,course from add_student where id = $id";
            $result = mysqli_query($conn,$sql);
            $row = mysqli_fetch_assoc($result);
           } ?>
 <h1 style="text-align: center; color: limegreen;">Result input form</h1>
       <form method="post" action="result_form_action.php" style="background-color:skyblue;">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="form-group">
				...
				<input type="number" name="Physics" class="form-control" placeholder="Enter Result.." required="">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label><b>Botany:-</b></label>
				<input type="number" name="botany" class="form-control" placeholder="Enter Result.." required="">
			</div>
		</div>
		<div class="col-lg-6">
			<div class="form-group">
			...
			<div class="form-group">
				...
				<input type="number" name="chemistry" class="form-control" placeholder="Enter Result.." required="">
			</div>
			<div class="form-group">
				<label><b>Zoology:-</b></label>
				<input type="number" name="zoology" class="form-control" placeholder="Enter Result.." required="">
